 ...
 *
 * **DOS SITIOS, DOS COSAS DISTINTAS** (28-08-2026, decidido por el dueño
 * después de verlo hecho al revés durante un día).
 *
 *   · La pestaña de abajo es **Chats**: conversaciones, y nada más. Su
 *     pastilla cuenta los mensajes que te escribieron y no has abierto.
 *   · La campana del inicio, arriba a la derecha, es la **bandeja**: lo que
 *     pasó — te aceptaron el puesto, te pidieron uno, sales mañana.
 *
 * Ayer se juntaron en una sola pestaña. Visto en el teléfono, no funciona:
 * quien va a la barra de abajo va a hablar con alguien, y llegaba a una lista
 * de sucesos donde había que buscar la conversación. Un sitio para escribir y
 * otro para enterarse.
 *
 * Que un mensaje aparezca en los dos —pastilla aquí, aviso en la campana— es
 * a propósito y está pedido: la campana cuenta lo que pasó, la pestaña lo que
 * hay que contestar. No es la misma pregunta.
 */
