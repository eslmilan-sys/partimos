/**
 * **No es la puerta de la app** — eso es `app/index.tsx`, que abre en `4a`.
 * Esto es el índice de trabajo: las 48 pantallas por tablero, para revisarlas
 * una a una sin recorrer el flujo entero. Vive en `/pantallas`.
 *
